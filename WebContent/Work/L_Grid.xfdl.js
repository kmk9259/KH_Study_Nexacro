(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("Grid00","44","50","1010","210",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_binddataset("ds_emp");
            obj.set_cellsizingtype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"59\"/><Column size=\"160\"/><Column size=\"160\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"57\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"ID\"/><Cell col=\"1\" text=\"Name\"/><Cell col=\"2\" text=\"Email\"/><Cell col=\"3\" text=\"Phone\"/><Cell col=\"4\" text=\"Dept.\"/><Cell col=\"5\" text=\"Salary\"/><Cell col=\"6\" text=\"Bonus\"/><Cell col=\"7\" text=\"Manager\"/><Cell col=\"8\" text=\"Hire Date\"/><Cell col=\"9\" text=\"Ent Date\"/><Cell col=\"10\" text=\"ENT_YN\" displaytype=\"checkboxcontrol\"/></Band><Band id=\"body\"><Cell text=\"bind:EMP_ID\" textAlign=\"center\"/><Cell col=\"1\" text=\"bind:EMP_NAME\"/><Cell col=\"2\" text=\"bind:EMAIL\" tooltiptext=\"bind:EMAIL\"/><Cell col=\"3\" text=\"bind:PHONE\" displaytype=\"mask\" edittype=\"mask\" maskeditformat=\"###-####-####\" maskedittype=\"string\"/><Cell col=\"4\" text=\"bind:DEPT_CODE\" displaytype=\"combotext\" edittype=\"combo\" combocodecol=\"DEPT_CD\" combodatacol=\"DEPT_NAME\" combodataset=\"ds_dept\"/><Cell col=\"5\" text=\"bind:SALARY\" displaytype=\"number\" edittype=\"normal\"/><Cell col=\"6\" text=\"bind:BONUS\" displaytype=\"number\"/><Cell col=\"7\" text=\"bind:MANAGER_ID\" displaytype=\"combotext\" combocodecol=\"EMP_ID\" combodatacol=\"EMP_NAME\" combodataset=\"ds_emp\"/><Cell col=\"8\" text=\"bind:HIRE_DATE\" displaytype=\"calendarcontrol\" edittype=\"date\"/><Cell col=\"9\" text=\"bind:ENT_DATE\" displaytype=\"calendarcontrol\" edittype=\"date\"/><Cell col=\"10\" text=\"bind:ENT_YN\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\" checkboxtruevalue=\"Y\" checkboxfalsevalue=\"N\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("MaskEdit00","75","433","300","76",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            this.addChild(obj.name, obj);

            obj = new Combo("Combo00","72","538","306","76",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Edit("Edit00","78","328","294","76",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            this.addChild(obj.name, obj);
